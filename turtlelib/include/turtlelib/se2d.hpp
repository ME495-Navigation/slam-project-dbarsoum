...
namespace turtlelib
{
    ...
    /// following a constant twist (in its own original body frame) for one time unit
    /// \param tw - the twist
    /// \return the transformation corresponding to the rigid body following
    /// the given twist for one time unit
